...
LET IN END BACKSLASH DOT DEF SEMICOLON PARALLEL LOCAL TUNIT TBOOL TINT COLON EOF REC
%start def_parser exp_parser type_parser
%type <Krivine.definition> def_parser /* Returns definitions */
%type <Krivine.exptree> exp_parser /* Returns expression */
%type <Krivine.exptype> type_parser
%%
...
def:
  term_def                               {$1}
| def PARALLEL term_def                  {Parallel([$1; $3])}
| def SEMICOLON term_def                 {Sequence([$1; $3])}
;
